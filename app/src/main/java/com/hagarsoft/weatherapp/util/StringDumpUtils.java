            ...
            if (next == null ||
                ...
                if (visitorMap.containsKey(next)) {
                    ...
                    if (next.getClass().isArray()) {
                        builder.append("[").append(next.getClass().getName()).append(":").append(String.format(SYS_ID_FORMAT, sysId));
                        ...
                        if (fieldList.isEmpty()) {
                            ...
                            for (int i = fieldList.size() - 1; i >= 0; i--) {
                                ...
                                try {
                                    ...
                                    fieldObject = String.format(ERROR_FORMAT, e.getClass().getName(), e.getMessage());
                                }
